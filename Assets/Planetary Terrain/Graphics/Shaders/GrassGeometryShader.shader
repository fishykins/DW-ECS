...
#pragma target 4.0
	...
	void geom(point v2g IN[1], inout TriangleStream<g2f> triStream)
	{
		...
		float3 perpendicularAngle = cross(IN[0].norm, float3(0, 1, 0));
		...
		perpendicularAngle = cross(IN[0].norm, float3(1, 0, 0));
		...
		perpendicularAngle = cross(IN[0].norm, float3(0, 0, 1));
